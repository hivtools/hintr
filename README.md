...
[![R-CMD-check](https://github.com/hivtools/hintr/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/hivtools/hintr/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
For a more complete example of running on a network see [docker test script](https://github.com/hivtools/hintr/blob/main/docker/test).
