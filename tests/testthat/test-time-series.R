test_that("get_programme_time_series returns data and columns", {
  ...
  expect_equal(columns[[4]]$id, scalar("area"))
  expect_equal(columns[[4]]$column_id, scalar("area_id"))
  expect_equal(columns[[4]]$label, scalar("Area"))
  expect_equal(columns[[5]]$id, scalar("area_name"))
  ...
  expect_length(selected_filters, 2)
  expect_equal(names(selected_filters), c("plot_type", "area_level"))
})
